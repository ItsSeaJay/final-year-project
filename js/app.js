(function () {
	...
	var app = new Vue({
		...
		created: function () {
			...
			var request = window.indexedDB.open('final-year-project-battle-tracker', 1); // The second parameter is the version number
			request.onupgradeneeded = function(event) {
				db = event.target.result;

				var objectStore = db.createObjectStore('characters', { keyPath: 'ssn' });
